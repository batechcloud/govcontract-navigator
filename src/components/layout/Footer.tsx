        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm max-w-xs">
              AI-powered government contract search and bid management for businesses of all sizes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/solutions" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Solutions</Link></li>
              ...
              <li><Link to="/capability-statement" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Free Tools</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tutorials" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Tutorials</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/privacy" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Privacy</Link></li>
              <li><Link to="/terms" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Terms</Link></li>
            </ul>
          </div>
        </div>
